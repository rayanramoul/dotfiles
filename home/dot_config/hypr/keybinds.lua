...
hl.bind(
	mainMod .. " + End",
	hl.dsp.exec_cmd([[grim -g "$(slurp)" - | satty --filename - --copy-command wl-copy --early-exit]])
)
...
hl.bind(
	mainMod .. " + SHIFT + A",
	hl.dsp.exec_cmd("chezmoi apply --force --less-interactive --keep-going && hyprctl reload")
)
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("ghostty -e nvim " .. home .. "/Documents/Notes"))

-- Wallpapers
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("noctalia msg wallpaper-next"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("noctalia msg wallpaper-previous"))
...
-- Cheatsheet: glow-rendered README keybindings in a floating terminal.
...
hl.bind(
	mainMod .. " + slash",
	hl.dsp.exec_cmd(
		"ghostty --class=dev.local.cheatsheet -e glow -p " .. home .. "/.local/share/chezmoi/README.md"
	)
)
